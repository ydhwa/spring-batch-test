package com.example.springbatchtest.job.tasklet;
...
/**
 * github.com/ashishkumar-07/remote-file-loading
 */
@Slf4j
public class DeleteJobRepositoryTasklet implements Tasklet, InitializingBean {
    ...
    private Integer noOfDaysToKeep = 0;
    ...
    public DeleteJobRepositoryTasklet(DataSource dataSource) {
